...
public interface JwtBuilder extends ClaimsMutator<JwtBuilder> {
     ...
     * consider using {@link #signWith(Key, io.jsonwebtoken.security.SignatureAlgorithm)} instead.
     *
     ...
     * {@link SignatureAlgorithms#RS256 RS256}, {@link SignatureAlgorithms#RS384 RS384}, and
     * {@link SignatureAlgorithms#RS512 RS512} algorithms, so we assume an RSA signature algorithm based on the key
     ...
     * </ol>
     *
     * <p>This implementation does not use the {@link SignatureAlgorithms#PS256 PS256},
     * {@link SignatureAlgorithms#PS384 PS384}, or {@link SignatureAlgorithms#PS512 PS512} RSA variants for any
     * specified {@link RSAKey} because the the {@link SignatureAlgorithms#RS256 RS256},
     * {@link SignatureAlgorithms#RS384 RS384}, and {@link SignatureAlgorithms#RS512 RS512} algorithms are
     ...
     * {@link #signWith(Key, io.jsonwebtoken.security.SignatureAlgorithm)} method instead.</p>
     *
     ...
     * @see #signWith(Key)
     * @deprecated since 0.10.0. Use {@link #signWith(Key, io.jsonwebtoken.security.SignatureAlgorithm)} instead.
     ...
     * @see #signWith(Key)
     * @since 0.10.0
     * @deprecated since JJWT_RELEASE_VERSION to use the more flexible {@link #signWith(Key, io.jsonwebtoken.security.SignatureAlgorithm)}.
     */
    @Deprecated
