...
public class OrgJsonReader implements Reader<Object> {

    @Override
    public Object read(java.io.Reader in) throws IOException {
        Assert.notNull(in, "Reader cannot be null.");
        try {
            return parse(in);
        } catch (Throwable t) {
            String msg = "Unable to read JSON: " + t.getMessage();
