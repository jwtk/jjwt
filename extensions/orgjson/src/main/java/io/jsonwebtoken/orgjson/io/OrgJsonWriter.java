...
public class OrgJsonWriter<T> implements Writer<T> {
    ...
    public void write(java.io.Writer out, T t) throws IOException {
        try {
            ...
            String msg = "Cannot write object of type " + Objects.nullSafeClassName(t) + " to JSON: " + ex.getMessage();
            throw new IOException(msg, ex);
        }
    }

    protected void writeObject(java.io.Writer out, T t) throws IOException {
