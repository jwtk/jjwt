...
class OrgJsonWriterTest {

    private OrgJsonWriter writer

    @Before
    void setUp() {
        writer = new OrgJsonWriter()
    }
    ...
    void loadService() {
        ...
        assertTrue writer instanceof OrgJsonWriter
    }
    ...
    void testInvalidArgument() {
        try {
            ...
            String msg = 'Unable to serialize object of type java.lang.Object to JSON using known heuristics.'
            assertEquals msg, expected.message
        }
    }

    @Test
    void testWriteObjectRuntimeException() {

        final IllegalArgumentException iae = new IllegalArgumentException("foo")

        writer = new OrgJsonWriter() {
            @Override
            protected void writeObject(java.io.Writer out, Object o) throws IOException {
                throw iae
            }
        }
        try {
            ...
            String msg = 'Cannot write object of type java.lang.String to JSON: foo'
            assertEquals msg, expected.getMessage()
            assertSame iae, expected.getCause()
        }
    }
