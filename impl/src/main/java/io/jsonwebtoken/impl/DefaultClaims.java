...
public class DefaultClaims extends ParameterMap implements Claims {
    ...
    static final Parameter<Instant> EXPIRATION = Parameters.rfcDate(Claims.EXPIRATION, "Expiration Time");
    static final Parameter<Instant> NOT_BEFORE = Parameters.rfcDate(Claims.NOT_BEFORE, "Not Before");
    static final Parameter<Instant> ISSUED_AT = Parameters.rfcDate(Claims.ISSUED_AT, "Issued At");
    ...
    public <T> T get(String claimName, Class<T> requiredType) {
        ...
        if (Instant.class.equals(requiredType)) {
            try {
                value = JwtDateConverter.toInstant(value); // NOT specDate logic
            } catch (Exception e) {
