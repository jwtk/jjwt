...
class TestKeys {
    ...
    static {
        A128GCM = A128KW = A128GCMKW = Jwe.enc.A128GCM.key().build()
        A192GCM = A192KW = A192GCMKW = Jwe.enc.A192GCM.key().build()
        A256GCM = A256KW = A256GCMKW = Jwe.enc.A256GCM.key().build()
        AGCM = Collections.setOf(A128GCM, A192GCM, A256GCM)
    }

    static SecretKey A128CBC_HS256 = Jwe.enc.A128CBC_HS256.key().build()
    static SecretKey A192CBC_HS384 = Jwe.enc.A192CBC_HS384.key().build()
    static SecretKey A256CBC_HS512 = Jwe.enc.A256CBC_HS512.key().build()
