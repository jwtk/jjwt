...
class HmacAesAeadAlgorithmTest {
    ...
    void testKeyBitLength() {
        ...
        assertEquals 256, Algorithms.enc.A128CBC_HS256.getKeyBitLength()
        assertEquals 384, Algorithms.enc.A192CBC_HS384.getKeyBitLength()
        assertEquals 512, Algorithms.enc.A256CBC_HS512.getKeyBitLength()
    }

    @Test
    void testGenerateKey() {
        def algs = [
                Algorithms.enc.A128CBC_HS256,
                Algorithms.enc.A192CBC_HS384,
                Algorithms.enc.A256CBC_HS512
        ]
    ...
    void testDecryptWithInvalidTag() {
        ...
        def alg = Algorithms.enc.A128CBC_HS256;
